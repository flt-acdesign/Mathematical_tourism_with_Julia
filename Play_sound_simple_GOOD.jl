...
# ╔═╡ a4aa07ba-9729-459c-a53a-5fb84e640a8c
using Sound, Plots

# ╔═╡ bb42b1d9-c40f-477f-bedd-897f98853934
function beep(freq_array::Array; t = .2)
...
plot(plot(wavr), plot(modu),layout = (1,2))

	
end

# ╔═╡ 29855004-0862-4fc2-b11c-ac93c2c97c43
beep([500 1500 200 150]; t = 2)
...
manifest_format = "2.0"
project_hash = "d87083484f32369ae036bc82d1f49e27230f0cf8"
