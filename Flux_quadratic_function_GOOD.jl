...
using Flux, Plots, PlutoUI  # import libraries for machine learning and plotting
...
begin
	...
	for epoch in 1:num_epochs   # iterate the training "num_epochs" times
	    ...
	    training_loss[epoch] = Flux.mse(model(X_train), Y_train) # store loss per iteration
	end
end
...
manifest_format = "2.0"
project_hash = "56978c3c46aac024e6622f9601f03c7746bfa0e3"
