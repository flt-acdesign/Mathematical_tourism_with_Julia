...
# ╔═╡ 8c5297ea-3f89-46d4-8090-b2e8a2dd941b
# Mandelbrot algorithm for a complex point "c" with Re and Im components of type BigFloat in order to capture "arbitrarily" small numbers
...
# ╔═╡ eec6144c-cbbb-463a-b181-96bc72b1cd49
# This function calls the Mandelbrot algorithm for each point in the rectangle of the complex plane defined by its center coordinates and a "delta" (δ) on each side of the center. Center and delta use the BigFloat type for arbitrary precision
...
mandelbrot_set = [mandelbrot(complex(BigFloat(r), BigFloat(i)), max_iter) for r in x, i in y]
"""
...
return mandelbrot_set  # This function returns an array with the number of iterations before divergence for each point in the domain of the complex plane under study
	
end

# ╔═╡ a9af18ae-6963-40fa-b482-97f854fa1aae
md"Set zoom 10^zoom = $(@bind zoom Slider(-.6:.01:7 ;default=-.4, show_value=true) ) "

# ╔═╡ e232799f-1709-4afc-9609-1b17142d610d
δ = BigFloat(1/(10^zoom))  # Convert the "zoom" into the width of the interval

# ╔═╡ 4ed86617-4016-4aed-858c-f3735f208cc4
#save_animation()  # Invoke this function to write a gif file with an animation

# ╔═╡ 2b91c5cb-3af6-408b-ab7c-0e850cb19d39
begin
	# Default coordinates in the complex plane of the center of the image
	xcvideo = BigFloat(-1.74995768370609350360221450607069970727110579726252077930242837820286008082972804887218672784431700831100544507655659531379747541999999995)
	
	ycvideo = BigFloat(0.00000000000000000278793706563379402178294753790944364927085054500163081379043930650189386849765202169477470552201325772332454726999999995)

	md" Coordinates from this video  https://www.youtube.com/watch?v=aSg2Db3jF_4"
end

# ╔═╡ 2e063660-407c-4d3a-a8b8-6e6da3744897
...
# ╔═╡ 285ea124-53b5-4757-89e6-2fbb81fc8781
begin
	
#setprecision(BigFloat, 500)  # Enable this line to set arbitrary precision on the BigFloat type. Default value is 128 bits.

# The array to be plotted is the return value of the generate_mandelbrot function, note that the array needs to be transposed in order to obtain the usual orientation of the Mandelbrot set	
...
# Calculate the average value of the array with the number of iterations. This is used to set ad-hoc a color scale for plotting	
average = (sum(array_to_plot)/length(array_to_plot))	

end

# ╔═╡ 153e2cb3-be7f-4931-9537-76c0ddd2931e
begin
...
# ╔═╡ cd39323c-df18-43ad-89c7-ebea8aa8b1e0
# Create an animation with various images constructed with the Mandelbrot algorithm for variations of one parameter, in this case, the zoom value
